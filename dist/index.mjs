...
var View = React3.forwardRef((props, ref) => {
...
var SafeAreaView = ({
  ...
  return /* @__PURE__ */ jsx4(
    NativeSafeAreaView,
    {
      ...
      children: /* @__PURE__ */ jsx4(View_default, { flex, color, style, ...rest, children })
    }
  );
};
...
import { Text as Char } from "react-native";
...
var ScrollView = React5.forwardRef((props, ref) => {
  const { colors } = use_color_default();
  const {
    // Spacing props
    padding,
  ...
  const handleScroll = animated ? Animated2.event(
    [
      {
        nativeEvent: {
          contentOffset: {
...
var FlatList = React6.forwardRef((props, ref) => {
  const { colors } = use_color_default();
  const {
    // Spacing props
    padding,
  ...
  const handleScroll = animated ? Animated3.event(
    [
      {
        nativeEvent: {
          contentOffset: {
...
var Image = (props) => {
  ...
  const fastImageProps = useMemo9(() => ({
    ...otherProps,
    source: isValidSource ? { uri: source.uri } : source,
    style: computedStyle,
    resizeMode: FastImage.resizeMode[resizeMode],
    priority: priority ? FastImage.priority[priority] : void 0,
    cache: cache ? FastImage.cacheControl[cache] : void 0,
    onLoad,
    onError,
    onLoadStart,
    onLoadEnd,
  ...
  return /* @__PURE__ */ jsx11(Fragment, { children: isValidSource ? /* @__PURE__ */ jsx11(FastImage, { ...fastImageProps }) : /* @__PURE__ */ jsx11(View_default, { style: computedStyle, fd: "flex-center" }) });
};
...
var KeyboardView = (props) => {
  ...
  const keyboardBehavior = useMemo10(() => {
    if (behavior) return behavior;
    return ios ? "padding" : "height";
  }, [behavior, ios]);
  const keyboardOffset = useMemo10(() => {
...
var AlertModal = (props) => {
  ...
  const computedTitleStyle = useMemo12(() => {
    return {
      fontSize: 16,
      fontWeight: "600",
      textAlign: "center",
  ...
  const computedTextStyle = useMemo12(() => {
    return {
      fontSize: 13,
      textAlign: "center",
      ...textStyle
  ...
  const computedButtonContainerStyle = useMemo12(() => {
    return {
      gap: 12,
      ...buttonContainerStyle
    };
  ...
  const modalContent = useMemo12(() => {
    ...
    return /* @__PURE__ */ jsxs(View_default, { color: "background", ph: 24, pt: 24, pb: 5, br: 24, style: computedContentStyle, gap: 24, children: [
      icon && /* @__PURE__ */ jsx14(View_default, { size: 40, br: 40, color: `${color}Light`, align: "center", fd: "flex-center", children: /* @__PURE__ */ jsx14(Svg_default, { icon, size: 22, color }) }),
      /* @__PURE__ */ jsxs(View_default, { gap: 16, children: [
        /* @__PURE__ */ jsx14(Text_default, { style: computedTitleStyle, color: "text", children: title }),
        text && /* @__PURE__ */ jsx14(Text_default, { style: computedTextStyle, color: "text2", children: text })
      ] }),
  ...
  return /* @__PURE__ */ jsx14(
    Modal,
    {
      ...
      accessibilityRole,
      style: modalStyle,
      children: keyboardAvoidingView ? /* @__PURE__ */ jsx14(KeyboardView_default, { keyboardVerticalOffset, children: /* @__PURE__ */ jsxs(View_default, { flex: 1, style: backdropStyle, fd: "flex-center", p: 25, children: [
        modalContent,
...
var OptionModal = (props) => {
  ...
  const closeFunc = useMemo13(() => {
    return () => {
      setModal(false);
    };
  }, [setModal]);
  const backdropStyle = useMemo13(() => {
    const backdropColorValue = backdropColor ? colors[backdropColor] || backdropColor : colors.modal;
    return {
      backgroundColor: backdropColorValue,
      opacity: backdropOpacity
  ...
  const computedContentStyle = useMemo13(() => {
    return {
  ...
  const computedOptionStyle = useMemo13(() => {
    return {
      flexDirection: "row",
      alignItems: "center",
      gap: 16,
  ...
  const computedOptionTextStyle = useMemo13(() => {
    return {
      fontSize: 13,
      ...optionTextStyle
    };
  }, [optionTextStyle]);
  const computedOptionIconStyle = useMemo13(() => {
    return {
      width: 40,
      height: 40,
      borderRadius: 40,
  ...
  const optionsList = useMemo13(() => {
    if (customContent) {
      return customContent;
    }
    return /* @__PURE__ */ jsxs2(View_default, { color: "background", br: 24, style: computedContentStyle, children: [
      header && /* @__PURE__ */ jsx15(View_default, { p: 16, pb: 8, children: header }),
      /* @__PURE__ */ jsx15(View_default, { children: options.map((item, i) => /* @__PURE__ */ jsxs2(
        TouchableOpacity_default,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs2(View_default, { flex: 1, children: [
              ...
              item.text && /* @__PURE__ */ jsx15(Text_default, { size: 12, color: "text2", children: item.text })
            ] }),
            item.rightIcon && /* @__PURE__ */ jsx15(Svg_default, { icon: item.rightIcon, color: "text2", size: 16 }),
            item.rightText && /* @__PURE__ */ jsx15(Text_default, { size: 12, color: "text2", children: item.rightText }),
            item.badge && /* @__PURE__ */ jsx15(
              View_default,
              {
                size: 20,
                br: 10,
                color: "primary",
                fd: "flex-center",
                children: /* @__PURE__ */ jsx15(Text_default, { size: 10, color: "white", weight: "SemiBold", children: item.badge })
              }
            )
          ]
        },
      ...
      footer && /* @__PURE__ */ jsx15(View_default, { p: 16, pt: 8, children: footer })
    ] });
  }, [
    customContent,
    header,
  ...
  return /* @__PURE__ */ jsx15(
    Modal2,
    {
      ...
      accessibilityRole,
      style: modalStyle,
      children: keyboardAvoidingView ? /* @__PURE__ */ jsx15(KeyboardView_default, { keyboardVerticalOffset, children: /* @__PURE__ */ jsxs2(View_default, { flex: 1, style: backdropStyle, fd: "flex-center", p: 25, children: [
        optionsList,
        /* @__PURE__ */ jsx15(View_default, { inset: 0, onTouchEnd: handleBackdropPress })
...
var Modal3 = ({ modal, setModal, close, full, children }) => {
  ...
  return /* @__PURE__ */ jsx17(Fragment2, { children: /* @__PURE__ */ jsx17(
    Mod,
    {
      ...
      visible: modal,
      onRequestClose: closeFunc,
      children: /* @__PURE__ */ jsx17(KeyboardView_default, { children: /* @__PURE__ */ jsxs4(View_default, { flex: 1, color: "modal", children: [
        /* @__PURE__ */ jsx17(TouchableWithoutFeedback, { onPress: closeFunc, children: /* @__PURE__ */ jsx17(View_default, { flex: full ? 0.1 : 1 }) }),
        /* @__PURE__ */ jsxs4(
          View_default,
          {
            color: "background",
            ...
            children: [
              /* @__PURE__ */ jsx17(View_default, { pv: 10, pb: 25, onTouchStart: closeFunc, children: /* @__PURE__ */ jsx17(View_default, { width: 50, height: 4, color: "medium", br: 3, align: "center" }) }),
              children,
              /* @__PURE__ */ jsx17(View_default, { height: ios ? 40 : 0 })
            ]
          }
        )
      ] }) })
...
import { Animated as Animated4, Easing } from "react-native";
...
var LoadingDots = ({ color, size = 6, duration = 600 }) => {
  const progress = useRef2(
    Array.from({ length: DOT_COUNT }, () => new Animated4.Value(0))
  ).current;
  useEffect3(() => {
    const animations = progress.map(
      (value, index) => Animated4.loop(
        Animated4.sequence([
          Animated4.delay(index * (duration / DOT_COUNT)),
          Animated4.timing(value, {
            toValue: 1,
            duration: duration / 2,
  ...
  return /* @__PURE__ */ jsx18(View_default, { fd: "flex-row", children: progress.map((value, index) => /* @__PURE__ */ jsx18(
    Animated4.View,
    {
      style: {
        width: size,
...
var Button = (props) => {
  ...
  return /* @__PURE__ */ jsx18(Fragment3, { children: /* @__PURE__ */ jsx18(TouchableOpacity_default, { onPress, disabled: disable, children: /* @__PURE__ */ jsxs5(
    View_default,
    {
      mv,
      ...
      children: [
        ...
        loading && /* @__PURE__ */ jsx18(View_default, { ml: 10, children: /* @__PURE__ */ jsx18(LoadingDots, { color: typeof loaderColor === "string" ? loaderColor : String(loaderColor), size: 6 }) })
      ]
    }
  ) }) });
};
...
var Label = (props) => {
  ...
  return /* @__PURE__ */ jsx20(Fragment4, { children: /* @__PURE__ */ jsx20(View_default, { mb: InputConfig_default.label.spacingBottom, children: /* @__PURE__ */ jsx20(
    Text_default,
    {
...
import { Fragment as Fragment5, jsx as jsx24, jsxs as jsxs7 } from "react/jsx-runtime";
var Loader = ({ text, loading, color }) => {
  const { colors } = use_color_default();
  return /* @__PURE__ */ jsx24(Fragment5, { children: loading && /* @__PURE__ */ jsxs7(View_default, { flex: 1, fd: "col-center", pv: 25, children: [
...
// src/rn-alpha/custom/Inputs/Select.tsx
import { Fragment as Fragment6, jsx as jsx25, jsxs as jsxs8 } from "react/jsx-runtime";
var Select = (props) => {
  var _a, _b;
  const {
  ...
  return /* @__PURE__ */ jsxs8(Fragment6, { children: [
    renderSelect ? /* @__PURE__ */ jsx25(TouchableWithoutFeedback2, { disabled, onPress: () => {
      Keyboard.dismiss();
      setModal(true);
      ...
      /* @__PURE__ */ jsx25(TouchableWithoutFeedback2, { disabled, onPress: () => {
        Keyboard.dismiss();
        setModal(true);
    ...
    /* @__PURE__ */ jsx25(Modal_default, { setModal: submit, modal, full: search2, children: /* @__PURE__ */ jsxs8(View_default, { flex: 1, children: [
      ...
      search2 && /* @__PURE__ */ jsx25(View_default, { ph: selectConfig.modalPadding, children: /* @__PURE__ */ jsx25(SearchInput_default, { filter, setFilter }) }),
...
var SearchInput = (props) => {
  ...
  return /* @__PURE__ */ jsx27(Fragment7, { children: /* @__PURE__ */ jsxs9(
    View_default,
    {
...
import { TouchableWithoutFeedback as TouchableWithoutFeedback3, useColorScheme as useColorScheme2 } from "react-native";
...
var DateSelect = ({ placeholder, bw, mt, label, error, onChangeText, value = /* @__PURE__ */ new Date(), style, minimumDate }) => {
  ...
  return /* @__PURE__ */ jsxs10(View_default, { mt, style, children: [
    ...
    /* @__PURE__ */ jsx28(TouchableWithoutFeedback3, { onPress: onOpen, children: /* @__PURE__ */ jsxs10(
      View_default,
      {
        br: control.radius,
        fd: "flex-center",
...
import { Keyboard as Keyboard2, TouchableWithoutFeedback as TouchableWithoutFeedback4, useColorScheme as useColorScheme3 } from "react-native";
...
var DateTimeInput = (props) => {
  ...
  const isDarkMode = useColorScheme3() === "dark";
  const { colors } = use_color_default();
...
import { TouchableWithoutFeedback as TouchableWithoutFeedback5 } from "react-native";
...
var Checkbox = (props) => {
  ...
  return /* @__PURE__ */ jsx30(TouchableWithoutFeedback5, { onPress: () => setSelected(!selected), children: /* @__PURE__ */ jsx30(View_default, { children: selected ? /* @__PURE__ */ jsx30(
    View_default,
    {
...
import { Modal as Modal4 } from "react-native";
...
var Preloader = (props) => {
  ...
  return /* @__PURE__ */ jsx32(Fragment8, { children: /* @__PURE__ */ jsx32(
    Modal4,
    {
      ...
      children: /* @__PURE__ */ jsx32(View_default, { flex: 1, color: "#1F2021A3", fd: "flex-center", children: /* @__PURE__ */ jsxs13(View_default, { height: 120, position: "absolute", fd: "col-center", children: [
...
var TextInput4 = React21.forwardRef((props, ref) => {
  const { colors } = use_color_default();
  const {
    onChangeText,
    label,
...
var Menu = (props) => {
  ...
  const { colors } = use_color_default();
  return /* @__PURE__ */ jsx35(Fragment9, { children: /* @__PURE__ */ jsx35(
    Component,
    {
      visible: modal,
      anchor: /* @__PURE__ */ jsx35(TouchableOpacity_default, { onPress: () => setModal(true), children: anchor }),
      onRequestClose: () => {
        setModal(false);
      },
      style: {
      ...
      children: options.map((data, i) => (data.visible === void 0 || data.visible) && /* @__PURE__ */ jsx35(
        MenuItem,
        {
          onPress: () => {
            setModal(false);
...
import { useEffect as useEffect6, useMemo as useMemo14 } from "react";
